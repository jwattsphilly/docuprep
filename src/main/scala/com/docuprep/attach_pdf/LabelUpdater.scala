 ...
 * If a Count case class is sent, the timer label in AddPDF_GUI is updated.
 * If a ReportCount case class is sent, the report timer label in AddPDF_GUI is updated.
